    ...
    items:
      - type: Card
        ...
        text: >+
          ...
          <div style="text-align: left">WinPE 維修碟Tails 隱私系統遠端幫手機安裝 Windows多啟動
          (可放入多個映像檔)隨插即用 Android (Prime OS) 系統資訊護盾 (一款實體卡片，包含悠遊卡，一卡通等，以及門禁卡感應)
          加上真實的具有實體強密碼口令產生的效果。魔力書籤 －自我同步的數位卡片或名片 以動態 QR 呈現。所以即使你沒插電，我們後端正幫你
          update。深度筆記本 －
          一款簡約，實用，可放入口袋便攜式的最安全存儲。不是叫你寫日記，而是裏頭智慧設計，使你簡便的管理資料。</div>
